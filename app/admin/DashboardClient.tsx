...
interface DashboardProps {
  metrics: { label: string; value: string; change: string; trend: string; icon: React.ElementType; color: string; bg: string; }[];
  secondaryMetrics: { label: string; value: string; icon: React.ElementType; }[];
  activityData: { time: string; convos: number; leads: number }[];
  leadData: { day: string; count: number }[];
}

export function AdminDashboardClient({ metrics, secondaryMetrics, activityData, leadData }: DashboardProps) {
  return (
